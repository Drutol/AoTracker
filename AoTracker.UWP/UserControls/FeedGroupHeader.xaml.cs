...
{
    public sealed partial class FeedGroupHeader : UserControl
    {
        public static readonly DependencyProperty ParentWidthProperty = DependencyProperty.Register(
            "ParentWidth", typeof(double), typeof(FeedGroupHeader), new PropertyMetadata(default(double)));
