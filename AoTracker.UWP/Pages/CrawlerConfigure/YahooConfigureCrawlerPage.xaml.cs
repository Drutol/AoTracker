...
namespace AoTracker.UWP.Pages.CrawlerConfigure
{
    ...
    public sealed partial class YahooConfigureCrawlerPage
    {
        public YahooConfigureCrawlerPage()
        {
    ...
    public class YahooConfigureCrawlerPageBase : CustomPageBase<ConfigureYahooCrawlerViewModel>
    {
