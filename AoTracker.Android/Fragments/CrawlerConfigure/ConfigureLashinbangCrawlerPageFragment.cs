...
namespace AoTracker.Android.Fragments.CrawlerConfigure
{
    ...
    class ConfigureLashinbangCrawlerPageFragment : ConfigureCrawlerPageFragmentBase<ConfigureLashinbangCrawlerViewModel,
        LashinbangSourceParameters>
    {
        ...
        {
            base.InitBindings();
            DomainIcon.SetImageResource(Resource.Drawable.lashinbang);
        }
    }
}