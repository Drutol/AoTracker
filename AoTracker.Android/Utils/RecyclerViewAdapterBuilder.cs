        ...
        where THolder : RecyclerView.ViewHolder
    {
        ...
        public RecyclerView.Adapter Build()
        {
            if (_isMultipleViews)
            {
                ...
                {
                    StretchContentHorizonatally = _stretchHorizontally, StretchContentVertically = _stretchVertically
                };
            }

            if (_inflater == null)
                return new ObservableRecyclerAdapter<TItem, THolder>(_collection, _dataTemplate, _itemTemplate,
                    _holderTemplate);
            return new ObservableRecyclerAdapter<TItem, THolder>(_collection, _dataTemplate, _inflater,
                    _layoutResourceId, _holderTemplate)
                {StretchContentHorizonatally = _stretchHorizontally, StretchContentVertically = _stretchVertically};
        }
        ...
        public IMultipleViewsAdapterBuilder WithGroup<TGroupItem, TGroupHolder>(
            ...
            where TGroupItem : TItem where TGroupHolder : THolder
        {
        ...
        public interface IMultipleViewsAdapterBuilder : IBaseAdapterBuilder
        {
            IMultipleViewsAdapterBuilder WithGroup<TGroupItem, TGroupHolder>(
                Action<IMultipleViewsAdapterGroupBuilder<TGroupItem, TGroupHolder>> options)
                where TGroupHolder : THolder where TGroupItem : TItem;
        }
            ...
            where TGroupItem : TItem
        {
            ...
            IMultipleViewsAdapterGroupBuilder<TGroupItem, TGroupHolder> WithResourceId(LayoutInflater inflater,
                int layoutResourceId);
        }

        private class
            MultipleViewsAdapterGroupBuilder<TGroupItem, TGroupHolder> : IMultipleViewsAdapterGroupBuilder<TGroupItem,
                TGroupHolder> where TGroupItem : TItem where TGroupHolder : THolder
        {
            ...
            public IMultipleViewsAdapterGroupBuilder<TGroupItem, TGroupHolder> WithResourceId(LayoutInflater inflater,
                int layoutResourceId)
            {
